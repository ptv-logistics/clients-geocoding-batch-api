...
namespace PTV.Developer.Clients.geocoding.batch.Api
{
    ...
    public interface ILocationsApiSync : IApiAccessor
    {
        ...
        IdResponse CreateLocationsByAddresses(AddressesRequest addressesRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0);
        ...
        ApiResponse<IdResponse> CreateLocationsByAddressesWithHttpInfo(AddressesRequest addressesRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>IdResponse</returns>
        IdResponse CreateLocationsByTexts(TextsRequest textsRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of IdResponse</returns>
        ApiResponse<IdResponse> CreateLocationsByTextsWithHttpInfo(TextsRequest textsRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public interface ILocationsApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of IdResponse</returns>
        System.Threading.Tasks.Task<IdResponse> CreateLocationsByTextsAsync(TextsRequest textsRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class LocationsApi : ILocationsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>IdResponse</returns>
        public IdResponse CreateLocationsByAddresses(AddressesRequest addressesRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0)
        {
            PTV.Developer.Clients.geocoding.batch.Client.ApiResponse<IdResponse> localVarResponse = CreateLocationsByAddressesWithHttpInfo(addressesRequest, countryFilter, language);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of IdResponse</returns>
        public PTV.Developer.Clients.geocoding.batch.Client.ApiResponse<IdResponse> CreateLocationsByAddressesWithHttpInfo(AddressesRequest addressesRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0)
        {
        ...
        {
            PTV.Developer.Clients.geocoding.batch.Client.ApiResponse<IdResponse> localVarResponse = await CreateLocationsByAddressesWithHttpInfoAsync(addressesRequest, countryFilter, language, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>IdResponse</returns>
        public IdResponse CreateLocationsByTexts(TextsRequest textsRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0)
        {
            PTV.Developer.Clients.geocoding.batch.Client.ApiResponse<IdResponse> localVarResponse = CreateLocationsByTextsWithHttpInfo(textsRequest, countryFilter, language);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of IdResponse</returns>
        public PTV.Developer.Clients.geocoding.batch.Client.ApiResponse<IdResponse> CreateLocationsByTextsWithHttpInfo(TextsRequest textsRequest, List<string> countryFilter = default(List<string>), string language = default(string), int operationIndex = 0)
        {
        ...
        {
            PTV.Developer.Clients.geocoding.batch.Client.ApiResponse<IdResponse> localVarResponse = await CreateLocationsByTextsWithHttpInfoAsync(textsRequest, countryFilter, language, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
