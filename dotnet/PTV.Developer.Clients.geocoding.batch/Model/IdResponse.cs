...
namespace PTV.Developer.Clients.geocoding.batch.Model
{
    ...
    public partial class IdResponse : IEquatable<IdResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="IdResponse" /> class.
        /// </summary>
        /// <param name="id">The id of the geocoding request. (required).</param>
        public IdResponse(Guid? id = default(Guid?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for IdResponse and cannot be null");
            }
            this.Id = id;
        }
        ...
        /// </summary>
        /// <value>The id of the geocoding request.</value>
