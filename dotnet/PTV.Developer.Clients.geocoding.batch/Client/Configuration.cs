...
namespace PTV.Developer.Clients.geocoding.batch.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.myptv.com/geocoding-batch/v1";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api.myptv.com/geocoding-batch/v1"},
        ...
        public Configuration(
            ...
            string basePath = "https://api.myptv.com/geocoding-batch/v1") : this()
        {
        ...
        {
            string report = "C# SDK (PTV.Developer.Clients.geocoding.batch) Debug Report:\n";
