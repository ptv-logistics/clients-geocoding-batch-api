...
import com.ptvgroup.developer.client.geocoding.batch.model.Status;
...
public class LocationsSearchStatusResponse {
  ...
  public LocationsSearchStatusResponse() { 
  }

  public LocationsSearchStatusResponse status(Status status) {
    this.status = status;
    return this;
  }
  ...
  public LocationsSearchStatusResponse progress(Integer progress) {
  ...
  /**
   * Return true if this LocationsSearchStatusResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LocationsSearchStatusResponse locationsSearchStatusResponse = (LocationsSearchStatusResponse) o;
    return Objects.equals(this.status, locationsSearchStatusResponse.status) &&
        Objects.equals(this.progress, locationsSearchStatusResponse.progress);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getProgress() != null) {
      joiner.add(String.format("%sprogress%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProgress()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
