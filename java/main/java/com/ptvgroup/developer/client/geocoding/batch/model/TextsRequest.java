 ...
 */
@JsonPropertyOrder({
  TextsRequest.JSON_PROPERTY_TEXTS
})
...
public class TextsRequest {
  ...
  public TextsRequest texts(List<String> texts) {
    this.texts = texts;
    return this;
  }

  public TextsRequest addTextsItem(String textsItem) {
    if (this.texts == null) {
  ...
  /**
   * Return true if this TextsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TextsRequest textsRequest = (TextsRequest) o;
    return Objects.equals(this.texts, textsRequest.texts);
  }
