# Clients for the Geocoding Batch API (Version 1.3)
  ...
  * Polly (8.1.0)
  ...
  To initialize your client with your APIKey you can use the following snippet:
    ```
     ...
     LocationsApi locationsApi = new LocationsApi(configuration);
    ```
...
* **TypeScript:** Please add the following dependencies to your project
  ...
  * @types/node-fetch (2.6.9)
  ...
  To initialize your client with your APIKey you can use the following snippet:
    ...
    let locationsApi: LocationsApi = new LocationsApi(configuration);
    ```

 &nbsp;  
 &nbsp;  
 Please refer to our [Geocoding Batch API](https://developer.myptv.com/en/documentation/geocoding-places-api/concepts/batch-processing) documentation.